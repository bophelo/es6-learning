function fire(bool) {
    ...
    if (bool) {
        ...
        const names = ['Mike, Molly'];
        //var names = ['Frank', 'Fiona'];
        //names = ['Lip', 'Carl'];
        names.push('Debbie'); //const is not a 100 percent immutable, the assignment itself is immutable (the binding itself is immutable but the value is not)
        
        console.log(names);//2nd declaration gets returned for var and let but not const, results in type error
    }
    else {
